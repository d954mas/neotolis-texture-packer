...
**Spec refs.** §7.1–7.2, §10.4–10.5, §16–19, §22.3, §52.3, §52.5, §60.
...
5. Добавить adapter-level ownership test plan для raw RGBA; если lifetime нельзя закрепить без public engine contract, оформить отдельный upstream issue, не patch submodule.
...
**Dependencies.** F1-03, B0-02, F2-02.
...
**Dependencies.** F1-03, F2-05, B0-02, B1-02.
...
1. Выбрать Lua version/embedding/license и mechanically constrained template syntax.
