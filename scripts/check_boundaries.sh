...
tp_fs_internal          tp_fs_io|tp_fs_win32|tp_fs_posix|tp_build_worker|tp_job_worker_main|tp_job|tp_export_defold|tp_export_json_neotolis|tp_export_png|tp_file_lease|tp_identity|tp_image|tp_journal_io|tp_pack_hash|tp_pack_read|tp_project_parse|tp_project_save|tp_project_lease|tp_recovery|tp_recovery_backend_win32|tp_recovery_scan|tp_recovery_store|tp_scan|tp_format_discovery_win32|tp_lua_export_adapter|tp_runtime_path_win32
tp_format_binding_proto_internal tp_format_binding_proto|tp_format_catalog|tp_job_worker_internal|tp_job_worker_main|tp_lua_export_adapter_internal
tp_format_catalog_internal tp_format_catalog|tp_format_catalog_scan|tp_format_compile_worker|tp_export_run|tp_job|tp_lua_export_adapter
...
tp_format_diagnostic_internal tp_export_command_report|tp_export_command_report_proto|tp_export_run|tp_format_binding_proto|tp_format_catalog_scan|tp_format_compile_proto|tp_format_compile_service|tp_format_compile_worker|tp_format_diagnostic|tp_lua_export_adapter|tp_lua_host
...
tp_utf8_internal        tp_utf8|tp_build_proto|tp_export_command_report_proto|tp_export_png|tp_format_binding_proto|tp_format_catalog_scan|tp_format_compile_proto|tp_format_descriptor|tp_format_package|tp_fs_io|tp_image|tp_job_worker_proto|tp_json_internal|tp_lua_bindings|tp_lua_host|tp_op_validate|tp_project_identity|tp_source_path_text
...
tp_session_internal     tp_session|tp_session_snapshot|tp_session_layout|tp_recovery|tp_recovery_claim|tp_validate|tp_validate_target_settings|tp_export|tp_export_run|tp_input|tp_job|tp_sprite_index
...
tp_job_worker_internal  tp_build_worker_main|tp_export_command_report_proto|tp_job_worker_main|tp_job_worker_process_internal|tp_job_worker_proto
tp_job_worker_process_internal tp_job|tp_job_worker
tp_export_internal     tp_export|tp_export_defold|tp_export_json_neotolis|tp_export_png|tp_export_run|tp_format_binding_proto|tp_format_catalog|tp_lua_export_adapter
tp_export_command_report_internal tp_export_command_report|tp_export_command_report_proto|tp_export_command_report_proto_internal|tp_job|tp_job_worker_internal|tp_job_worker_main
tp_export_command_report_proto_internal tp_export_command_report_proto|tp_job_worker_proto
...
tp_lua_export_adapter_internal tp_job_worker_main|tp_lua_export_adapter
tp_lua_host_internal    tp_format_compile_service|tp_lua_export_adapter|tp_lua_host_private_internal
