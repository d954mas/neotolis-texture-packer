...
tp_journal_internal     tp_journal|tp_journal_io|tp_history|tp_txn_apply|tp_recovery|tp_recovery_backend_win32
...
tp_recovery_backend_types_internal tp_recovery|tp_recovery_backend_win32
