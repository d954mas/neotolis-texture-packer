...
if(FAMILY STREQUAL "new")
    ...
    run_json(0 "inspect;sprites=0;schema=2" inspect "${PROJ}" --json)  # F1: schema-2 contract pinned
...
elseif(FAMILY STREQUAL "anim")
    ...
    run_json(0 "anim;count=1;schema=2" anim list "${PROJ}" atlas1 --json)  # F1: id+name split, schema 2
